...
class AdminCategory extends StatefulWidget{
  var index;
  var category_name;
  AdminCategory({required Key key, @required this.index, @required this.category_name}) : super(key: key);
...
class AdminCategoryPage extends State<AdminCategory> {
  ...
  Future<List> viewCategoryItemsData() async{
    final responce = await http.get(Uri.parse("https://topstech8.000webhostapp.com/Ewishes/Category_images/category_images_view.php?data="+category_id.toString()));
...
class Items extends StatelessWidget {
  ...
  void deleteCategoryImages(var id){
    var url = "https://topstech8.000webhostapp.com/Ewishes/Category_images/category_images_unique_delete.php";
