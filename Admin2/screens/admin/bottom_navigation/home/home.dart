...
class AdminHomePage extends State<AdminHome> {
  Future<List> viewCategoryData() async{
    final responce = await http.get(Uri.parse("https://topstech8.000webhostapp.com/Ewishes/Category/category_view.php"));
...
class _Items extends State<Items>{
  ...
  XFile? _imageFile;
  final String uploadUrl = "https://topstech8.000webhostapp.com/Ewishes/Upload_category/upload_category_main_image_update.php";
  ...
  void _pickImage(var id) async {
    ...
    await uploadImage(_imageFile, uploadUrl+"?id="+id.toString());
  }
  ...
  void deleteCategory(var id){
    var url = "https://topstech8.000webhostapp.com/Ewishes/Category/category_delete.php";
  ...
  void deleteCategoryImages(var id){
    var url = "https://topstech8.000webhostapp.com/Ewishes/Category_images/category_images_delete.php";
    http.post(Uri.parse(url),body: {
      'data': id,
    });
  }
  ...
  void updateCategoryName(var id){
    var url = "https://topstech8.000webhostapp.com/Ewishes/Category/category_update.php";
    http.post(Uri.parse(url),body: {
      'id': id,
